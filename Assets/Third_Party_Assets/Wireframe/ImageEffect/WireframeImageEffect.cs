...
namespace Wireframe
{
    ...
    public class WireframeImageEffect : MonoBehaviour
    {
        ...
        [ColorUsage(true, true)] public Color wireColor = Color.green;
        [ColorUsage(true, true)] public Color baseColor = Color.black;
            ...
            if (wireframeType != lastWireframeType)
            {
                ...
                switch (wireframeType)
                {
                    case WireframeType.Solid:
                        cam.SetReplacementShader(Shader.Find("Wireframe/Wireframe-Global"), replacementTag);
                        break;
                    case WireframeType.ShadedUnlit:
                        cam.SetReplacementShader(Shader.Find("Wireframe/Wireframe-Shaded-Unlit-Global"), replacementTag);
                        break;
                    case WireframeType.Transparent:
                        cam.SetReplacementShader(Shader.Find("Wireframe/Wireframe-Transparent-Global"), replacementTag);
                        break;
                    case WireframeType.TransparentCulled:
                        cam.SetReplacementShader(Shader.Find("Wireframe/Wireframe-Transparent-Culled-Global"), replacementTag);
                        break;
                    default:
                        ResetCamera();
                        break;
